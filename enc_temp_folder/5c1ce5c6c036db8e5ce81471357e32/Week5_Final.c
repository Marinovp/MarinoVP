...
main(){
	...
	double percent, avg = 0;
	int grade=0, myGrades = 0;
	int passing, vaildGrades = 0;
	int total, totalGrades = 0;
	printf("Enter a test grade (-1 to quit:");
	scanf(" %i ", &myGrades);
	...
	printf("Passing: %i", passing / total);
	system("pause");
}
